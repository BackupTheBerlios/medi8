...
typedef struct consumer_monitor_s *consumer_monitor;

struct consumer_monitor_s
{
...
mlt_consumer 
consumer_monitor_init (char *arg)
{
  // Create the consumer object
  consumer_monitor this = calloc (sizeof (struct consumer_monitor_s), 1);
