 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public abstract class TrackFigure extends Figure implements
    PropertyChangeListener, IChangeListener
{
	/**
	...
	protected abstract class TrackMouseHandler implements MouseListener, MouseMotionListener
	{  
	}
